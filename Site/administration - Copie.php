...
<body>
  ...
  <div class="container">
    ...
    <ul class="collapsible" data-collapsible="expandable">
      <li class="">
        <div class="collapsible-header"><i class="material-icons">supervisor_account</i>Groupes<a href="#!" class="collection-item">  <span class="blue new badge " data-badge-caption="">4</span></a></div>
        <div class="collapsible-body" style="display: none;">
          
          <ul class="collapsible" data-collapsible="expandable">
            <li class="">
              <div class="collapsible-header"><i class="material-icons">supervisor_account</i>Groupe 1
                <span class="right">17<i class="material-icons right">person</i></span>
              </div>
              ...
              <tbody>
                <tr>
                  <td>Martin, Jean</td>
                  <td>8/15</td><td><a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">clear</i>'</td>
                  
                </tr>
                <tr>
                  <td>Leclerc, Paul</td>
                  <td>7/15</td><td><a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">clear</i></td>
          ...
          <td>7/15</td><td><a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">clear</i></td>
            ...
            <li class="">
              <div class="collapsible-header"><i class="material-icons">supervisor_account</i>Groupe 3
                <span class="right">36<i class="material-icons right">person</i></span>
              </div>
            ...
            <li class="">
              <div class="collapsible-header"><i class="material-icons">supervisor_account</i>Groupe 4
                <span class="right">34<i class="material-icons right">person</i></span>
              </div>
              <div class="collapsible-body" style="display: none;"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</span></div>
            </li>
            <li class="">
              <div class="collapsible-header"><i class="material-icons">supervisor_account</i>Groupe 7
                <span class="right">21<i class="material-icons right">person</i></span>
              </div>
              <div class="collapsible-body" style="display: none;"><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</span></div>
            </li>
          </ul>
