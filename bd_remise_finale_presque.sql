...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 09 Mars 2017 à 23:40
...
(23, NULL, NULL, NULL, 'i9NA8', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL);
...
--
ALTER TABLE `utilisateur_activites`
  MODIFY `ID_Eleve_Activite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
